    ...
    public partial class Edit_1_Authorization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionAssignee", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkResourceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permissions_PermissionAssignee",
                        column: x => x.FkPermissionAssigneeId,
                        principalSchema: "authorization",
                        principalTable: "PermissionAssignee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Permissions_Resources_ResourceId",
                        column: x => x.FkResourceId,
                        principalSchema: "authorization",
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogicalOperator = table.Column<byte>(type: "tinyint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignee_CreatedAt",
                schema: "authorization",
                table: "PermissionAssignee",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignee_CreatedBy",
                schema: "authorization",
                table: "PermissionAssignee",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignee_Id",
                schema: "authorization",
                table: "PermissionAssignee",
                column: "Id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignee_ModifiedAt",
                schema: "authorization",
                table: "PermissionAssignee",
                column: "ModifiedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionAssignee_ModifiedBy",
                schema: "authorization",
                table: "PermissionAssignee",
                column: "ModifiedBy");
            ...
            migrationBuilder.CreateIndex(
                ...
                schema: "authorization",
                table: "Permissions",
                columns: new[] { "FkPermissionAssigneeId", "FkResourceId", "Action" });

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_FkResourceId",
                schema: "authorization",
                table: "Permissions",
                column: "FkResourceId");
