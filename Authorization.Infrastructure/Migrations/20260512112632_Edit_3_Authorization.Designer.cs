...
namespace Authorization.Infrastructure.Migrations
{
    ...
    [Migration("20260512112632_Edit_3_Authorization")]
    partial class Edit_3_Authorization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Authorization.Domain.Entities.JoinDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("PermissionRuleId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_JoinDetail_CreatedAt");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("IX_JoinDetail_CreatedBy");

                    b.HasIndex("Id")
                        .IsUnique();

                    b.HasIndex("ModifiedAt")
                        .HasDatabaseName("IX_JoinDetail_ModifiedAt");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("IX_JoinDetail_ModifiedBy");

                    b.HasIndex("PermissionRuleId")
                        .IsUnique();

                    b.ToTable("JoinDetails", "authorization");
                });
            ...
            modelBuilder.Entity("Authorization.Domain.Entities.JoinDetail", b =>
                {
                    b.HasOne("Authorization.Domain.Entities.PermissionRule", "PermissionRule")
                        .WithOne("JoinDetail")
                        .HasForeignKey("Authorization.Domain.Entities.JoinDetail", "PermissionRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PermissionRule");
                });
