...
{
    public class PermissionRegistrarHostedService : IHostedService
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<PermissionRegistrarHostedService> _logger;

        public PermissionRegistrarHostedService(IServiceProvider serviceProvider, ILogger<PermissionRegistrarHostedService> logger)
        {
