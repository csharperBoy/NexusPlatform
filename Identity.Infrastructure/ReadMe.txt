...
or
Add-Migration Initial_Identity -Project Identity.Infrastructure -Context IdentityDbContext -Start "TraderServer.WebApi"
...
or
update-database -Project Identity.Infrastructure -Context IdentityDbContext -Start "TraderServer.WebApi"
