...
namespace Navigation.Infrustructure.Migrations
{
    ...
    [Migration("20260630104219_Edit_1_Navigation")]
            ...
            modelBuilder.Entity("Core.Domain.Common.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessages", "navigation");
                });

            modelBuilder.Entity("Navigation.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Menu", "navigation");
                });

            modelBuilder.Entity("Navigation.Domain.Entities.Menu", b =>
                {
                    b.HasOne("Navigation.Domain.Entities.Menu", "Parent")
                        .WithMany("Children")
