...
namespace HR.Infrastructure.Migrations
{
    ...
    [Migration("20260811153612_Edit_7_HR")]
    partial class Edit_7_HR
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR.Domain.Entities.EmploymentInfoView", b =>
                {
                    ...
                    b.Property<DateTime?>("AssignmentsEffectiveTo")
                        .HasColumnType("datetime2")
                    ...
                    b.Property<DateTime?>("EmploymentLocationsEffectiveFrom")
                        .HasColumnType("datetime2")
                        .HasColumnName("EmploymentLocations_EffectiveFrom");

                    b.Property<DateTime?>("EmploymentLocationsEffectiveTo")
                        .HasColumnType("datetime2")
                    ...
                    b.ToView("Employment_Info_View", "hr");
                });
            ...
            modelBuilder.Entity("HR.Domain.Entities.LocationContact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HR.Domain.Entities.PostLocation", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_PostLocation");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_PostLocation_CreatedAt");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("IX_PostLocation_CreatedBy");

                    b.HasIndex("Id")
                        .IsUnique();

                    b.HasIndex("ModifiedAt")
                        .HasDatabaseName("IX_PostLocation_ModifiedAt");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("IX_PostLocation_ModifiedBy");

                    b.HasIndex(new[] { "FkLocationId" }, "IX_PostLocations_fkLocationId");

                    b.HasIndex(new[] { "FkPostId" }, "IX_PostLocations_fkPostId");

                    b.ToTable("PostLocations", "hr");
                });
