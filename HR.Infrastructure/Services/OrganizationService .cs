...
namespace HR.Infrastructure.Services
{
    ...
    public class OrganizationService : IOrganizationService
    {
        ...
        private readonly IRepository<HRDbContext, OrganizationUnit, Guid> _unitRepository;
        private readonly ISpecificationRepository<Post, Guid> _positionSpecRepository;
        private readonly IRepository<HRDbContext,Post, Guid> _positionRepository;
        ...
        public OrganizationService(
            ...
            IRepository<HRDbContext, OrganizationUnit, Guid> unitRepository,
            ISpecificationRepository<Post, Guid> positionSpecRepository,
        IRepository<HRDbContext, Post, Guid> positionRepository,
        ...
        public async Task<Post?> GetUserPositionAsync(Guid userId)
        {
            try
            {
...
*/
      ...
      */
       /* public async Task<string?> GetUnitPathAsync(Guid unitId)
        ...
        public async Task<Post?> GetUnitManagerAsync(Guid unitId)
        {
            try
            {
