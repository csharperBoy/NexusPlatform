...
namespace HR.IrisaSync.Extention.Data
{
    ...
    public class IrisaExtentionDbContextFactory : IDesignTimeDbContextFactory<IrisaExtentionDbContext>
    {
        public IrisaExtentionDbContext CreateDbContext(string[] args)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<IrisaExtentionDbContext>();
            optionsBuilder.UseSqlServer(conn, b =>
            {
                // 📌 تعیین اسمبلی محل Migrationها
                b.MigrationsAssembly(typeof(IrisaExtentionDbContext).Assembly.GetName().Name);
            ...
            return new IrisaExtentionDbContext(optionsBuilder.Options);
        }
    }
}
