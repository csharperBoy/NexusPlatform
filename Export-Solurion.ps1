...
#.\Export-Solurion.ps1 
# یا
#.\Export-Solurion.ps1 -SolutionPath "C:\Users\Mahar\source\repos\csharperBoy\NexusPlatform" -OutputPath "C:\Users\Mahar\source\repos\csharperBoy\NexusPlatform\TreeOutput.txt"
...
param(
    ...
    [string]$Output = "exports"   # مسیر خروجی یا نام فایل
)
...
# مسیر فایل خروجی نهایی (یک فایل واحد)
$outFile = Join-Path $Output "AllProjects.cs"
...
Write-Host "✅ Exported all projects to $outFile"
