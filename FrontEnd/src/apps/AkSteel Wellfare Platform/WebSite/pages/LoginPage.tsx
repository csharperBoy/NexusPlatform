...
const LoginForm: React.FC<LoginFormProps> = ({ 
  ...
  <Card className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
    ...
    <form className="p-12 md:p-24">
      <div className="flex items-center text-lg mb-6 md:mb-8">
        <Input type="text" id="username" className="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" />
        <svg className="absolute ml-3" width="24" viewBox="0 0 24 24">
          <path d="M20.822 18.096c-3.439-.794-6.64-1.49-5.09-4.418 4.72-8.912 1.251-13.678-3.732-13.678-5.082 0-8.464 4.949-3.732 13.678 1.597 2.945-1.725 3.641-5.09 4.418-3.073.71-3.188 2.236-3.178 4.904l.004 1h23.99l.004-.969c.012-2.688-.092-4.222-3.176-4.935z"/>
        </svg>
      </div>
      <div className="flex items-center text-lg mb-6 md:mb-8">
        <Input type="password" id="password" className="rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Password" />
