...
namespace HR.Application.Commands.JobTitle
{
   ...
   Optional<bool> IsActive
    ...
    public class UpdateJobTitleCommandHandler : IRequestHandler<UpdateJobTitleCommand, Result<bool>>
    {
        private readonly IJobTitleInternalService _service;
        private readonly ILogger<UpdateJobTitleCommandHandler> _logger;
        ...
        public async Task<Result<bool>> Handle(UpdateJobTitleCommand request, CancellationToken cancellationToken)
        {
            try
            {
