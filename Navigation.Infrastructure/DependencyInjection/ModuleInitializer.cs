    ...
    public class ModuleInitializer : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await NavigationSeedData.SeedNavigationForAuthorizationAsync(resourcePublicService,
                ...
                await NavigationSeedData.SeedNavigationAsync(repo, uow, _configuration, _logger);


                _logger.LogInformation("Navigation module initialization completed successfully.");
            }
            catch (Exception ex)
            {
                // 📌 ثبت خطا در صورت شکست عملیات
                _logger.LogError(ex, "An error occurred while initializing the Navigation module");
                throw;
            }
        }
